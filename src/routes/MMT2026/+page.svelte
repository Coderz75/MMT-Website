<script>
   ...
   const locations = [
    ...
    { name: "Nevada", date: "03/21/2026", location: "Coral Academy of Science (Sandy Ridge)", address: "1051 Sandy Ridge Ave, Henderson, NV 89052", early: "$15", earlyDate: "Feb 21", normal: "$20", normalDate: "March 7", late: "$25", lateDate: "March 14", link: "https://comp.mt/student/1/32" },
